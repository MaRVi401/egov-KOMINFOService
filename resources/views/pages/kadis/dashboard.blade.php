    ...
    <div class="p-4 mt-14">
        <div class="mb-8 border-b border-gray-200 pb-6 dark:border-gray-700">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-col md:flex-row items-center gap-4">
                    <div class="flex items-center justify-center space-x-3 md:space-x-4 bg-white dark:bg-gray-800 px-4 py-2 md:px-5 md:py-2.5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm transition-all hover:shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div class="p-5 bg-orange-50/50 border border-orange-100 rounded-xl shadow-sm dark:bg-orange-900/10 dark:border-orange-900/20">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-xs font-bold uppercase text-orange-600 dark:text-orange-400 tracking-wider">Perlu Persetujuan</p>
            ...
            <div class="p-5 bg-green-50/50 border border-green-100 rounded-xl shadow-sm dark:bg-green-900/10 dark:border-green-900/20">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-xs font-bold uppercase text-green-600 dark:text-green-400 tracking-wider">Usulan Disetujui</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-hidden flex flex-col min-h-112.5">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    @if($usulan->level_prioritas == 'tinggi')
                                        <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Tinggi</span>
                                    @elseif($usulan->level_prioritas == 'sedang')
                                        <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">Sedang</span>
                                    @else
                                        <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">Rendah</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <button type="button" 
                                        data-uuid="{{ $usulan->uuid }}"
                                        ...
                                        data-lampiran="{{ $usulan->tiket->lampiran ? Storage::url($usulan->tiket->lampiran) : '' }}"
                                        onclick="bukaModalReview(this)"
                ...
                <div class="w-full space-y-3 mt-auto">
                    ...
                    <div class="flex items-center justify-between text-xs font-bold uppercase text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 px-3 py-2.5 rounded-xl border border-gray-100 dark:border-gray-700">
                        <div class="flex items-center gap-2">
                            <span class="w-3 h-3 rounded-full shadow-sm" style="background-color: {{ ['#f59e0b', '#10b981', '#ef4444'][$index] }}"></span>
                            {{ $label }}
                        </div>
    ...
    <div id="modalReviewKadis" class="fixed inset-0 z-50 hidden bg-gray-900/60 backdrop-blur-sm overflow-y-auto h-full w-full flex items-center justify-center p-4">
        <div class="relative w-full max-w-5xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-6 md:p-8 border border-gray-100 dark:border-gray-700 flex flex-col max-h-[90vh]">
            ...
            <div class="flex justify-between items-center mb-6 shrink-0 border-b border-gray-100 dark:border-gray-700 pb-4">
                ...
                <button onclick="tutupModalReview()" type="button" class="text-gray-400 hover:text-red-500 transition-colors">
                    <i class="ti ti-x text-2xl"></i>
                </button>
            </div>

            <form id="formReviewKadis" method="POST" data-action-url="{{ route('kadis.usulan.update', ':uuid') }}" class="flex flex-col overflow-hidden">
                @csrf
                <div class="flex flex-col md:flex-row gap-6 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-600">
                    
                    <div class="w-full md:w-1/2 flex flex-col space-y-4">
                        <h4 class="text-sm font-bold text-gray-900 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2">Informasi Tiket</h4>
                        
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-xl border border-gray-100 dark:border-gray-700">
                                <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1">No Tiket</span>
                                <span id="rev-notiket" class="text-sm font-black text-gray-900 dark:text-white"></span>
                            </div>
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-xl border border-gray-100 dark:border-gray-700">
                                <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1">Kategori Layanan</span>
                                <span id="rev-layanan" class="text-sm font-bold text-gray-900 dark:text-white"></span>
                            </div>
                        </div>

                        <div class="bg-blue-50/50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800/50">
                            <span class="block text-[10px] font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400 mb-2">Catatan/Alasan Pengusul (Kabid)</span>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700">
                            <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Catatan/Deskripsi Operator</span>
                    ...
                    <div class="w-full md:w-1/2 flex flex-col gap-6 pt-6 md:pt-0 border-t md:border-t-0 md:border-l border-gray-100 dark:border-gray-700 md:pl-6">
                        <h4 class="text-sm font-bold text-gray-900 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2">Form Keputusan</h4>
                        
                        <div>
                            <label class="block text-xs font-bold uppercase text-gray-500 mb-3 tracking-widest">Keputusan Persetujuan</label>
                            <div class="grid grid-cols-2 gap-3">
                                <label class="cursor-pointer">
                                    <input type="radio" name="status_persetujuan" value="disetujui" class="peer hidden" required>
                                    <div class="text-center p-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20 peer-checked:border-green-500 peer-checked:text-green-700 dark:peer-checked:text-green-400 transition-all hover:border-green-300 flex flex-col items-center gap-2">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" name="status_persetujuan" value="ditolak" class="peer hidden" required>
                                    <div class="text-center p-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 peer-checked:bg-red-50 dark:peer-checked:bg-red-900/20 peer-checked:border-red-500 peer-checked:text-red-700 dark:peer-checked:text-red-400 transition-all hover:border-red-300 flex flex-col items-center gap-2">
                        ...
                        <div class="flex-1 flex flex-col">
                            <label class="block text-xs font-bold uppercase text-gray-500 mb-3 tracking-widest">Catatan Untuk Kabid / Operator</label>
                            <textarea name="catatan_kadis" rows="5" class="flex-1 w-full bg-gray-50 dark:bg-gray-700/50 border-2 border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-2xl p-4 focus:ring-0 focus:border-blue-500 outline-none resize-none transition-colors" placeholder="Tambahkan instruksi, alasan penolakan, atau catatan persetujuan di sini..."></textarea>
                        </div>
                    </div>
                </div>

                <div class="flex justify-end gap-3 pt-5 mt-5 border-t border-gray-100 dark:border-gray-700 shrink-0">
                    <button type="button" onclick="tutupModalReview()" class="px-5 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-bold rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition">Batal</button>
