...
@section('content')
    <div class="p-4 mt-14">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-500">Security & Audit (SIEM)</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
            {{-- Alert Card --}}
            <a href="{{ route('siem.security-logs', ['is_suspicious' => 1]) }}" class="p-6 rounded-base bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:border-red-500/50 transition-colors block">
                <div class="flex items-center justify-between mb-4">
                    <p class="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider">Peringatan Kritis (Alerts)</p>
            ...
            {{-- Audit/Logs Card --}}
            <a href="{{ route('siem.audit-trails') }}" class="p-6 rounded-base bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:border-blue-500/50 transition-colors block">
                <div class="flex items-center justify-between mb-4">
                    <p class="text-sm font-semibold text-slate-500 dark:text-slate-400 tracking-wider">Aktivitas Hari Ini</p>
