...
<div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
    ...
    {{-- STEP 1: PILIHAN (Sama seperti sebelumnya) --}}
    ...
    <div id="step-2" class="step-content hidden transition-opacity duration-300">
        ...
        <!-- {{-- FORM A: KHUSUS PERANGKAT DAERAH (Hidden Default) --}}
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_perangkat_daerah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                        </div>

                        {{-- Input Nama Kepala Instansi --}}
                        <div class="md:col-span-2">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kepala Instansi</label>
                            <input type="text" name="nama_kepala_instansi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Contoh: Dr. H. Dadang, M.Si" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_telp_instansi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="nama_pj" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="no_hp_pj" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-4 space-y-2">
                        ...
                        {{-- Opsi: Permohonan Baru --}}
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input checked id="opsi-baru" type="radio" value="baru" name="jenis_permohonan" class="w-4 h-4 text-blue-600 ..." onchange="toggleOpsiAkun()">
                            <label for="opsi-baru" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Permohonan Baru</label>
                        </div>

                        {{-- Opsi: Reset Password --}}
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="opsi-reset" type="radio" value="reset" name="jenis_permohonan" class="w-4 h-4 text-blue-600 ..." onchange="toggleOpsiAkun()">
                            <label for="opsi-reset" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Reset Password</label>
                        </div>

                        {{-- Opsi: Hapus Akun --}}
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="opsi-hapus" type="radio" value="hapus" name="jenis_permohonan" class="w-4 h-4 text-blue-600 ..." onchange="toggleOpsiAkun()">
                            <label for="opsi-hapus" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hapus Akun</label>
                        </div>

                        {{-- Opsi: Ganti Nama Akun --}}
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="opsi-ganti" type="radio" value="ganti" name="jenis_permohonan" class="w-4 h-4 text-blue-600 ..." onchange="toggleOpsiAkun()">
                            <label for="opsi-ganti" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ganti Nama Akun</label>
                        </div>
                    </div>

                    {{-- LOGIKA 1: Form Alasan (Muncul untuk Hapus ATAU Ganti) --}}
                    <div id="field-alasan" class="hidden mt-4 bg-yellow-50 p-4 rounded-lg border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-700">
                        ...
                        <textarea name="alasan_permohonan" rows="2" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Jelaskan alasan penghapusan atau penggantian nama akun..."></textarea>
                    </div>

                    {{-- LOGIKA 2: Form Usulan Nama (HANYA Muncul untuk Ganti Nama) --}}
                    <div id="field-usulan-nama" class="hidden mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Usulan Nama Email Baru</label>
                        <div class="flex">
                            <input type="text" name="usulan_nama_email" class="rounded-none rounded-l-lg bg-white border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="nama.baru">
                ...
                <div class="flex justify-end pt-4">
                    <button type="button" onclick="goToStep(3)" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        {{-- FORM B: KHUSUS ASN (Hidden Default) --}}
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama_lengkap" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Beserta gelar" required>
                    </div>

                    {{-- 2. NIP --}}
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIP</label>
                        <input type="number" name="nip" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Nomor Induk Pegawai" required>
                    </div>

                    {{-- 3. Jabatan --}}
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jabatan</label>
                        <input type="text" name="jabatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                    </div>

                    {{-- 4. Instansi --}}
                    <div class="md:col-span-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Instansi</label>
                        <input type="text" name="unit_kerja" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Nama Perangkat Daerah / Unit Kerja" required>
                    </div>

                    {{-- 5. No HP / WA --}}
                    <div class="md:col-span-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. HP / WhatsApp</label>
                        <input type="number" name="no_hp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="08..." required>
                    </div>

                    {{-- 6. Jenis Layanan (Enum) --}}
                    <div class="md:col-span-2">
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="goToStep(3)" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            ...
            <div id="form-perangkat-daerah" class="hidden form-section max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="mb-8">
                    ...
                    <div id="field-usulan-nama" class="hidden mt-4 bg-blue-50 p-4 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Usulan Nama Email Baru</label>
                        <div class="flex">
                            <input type="email" name="usulan_nama_email" class="rounded-none rounded-l-lg bg-white border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="nama.baru">
    ...
    <div id="step-3" class="step-content hidden transition-opacity duration-300">
        <div class="text-center py-10 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
            ...
            <h2 class="text-xl font-bold mb-2 dark:text-white">Permohonan Berhasil Dikirim!</h2>
