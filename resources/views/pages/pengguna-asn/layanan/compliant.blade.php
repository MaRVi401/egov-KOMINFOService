            ...
            <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="mb-8">
                    <div class="grid gap-6 md:grid-cols-1">
                        ...
                        <div>
                            <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ringkasan Masalah (Subjek)</label>
                            <input type="text" id="deskripsi" name="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Contoh: Aplikasi SIMPEG error tidak bisa cetak laporan" required>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Tuliskan inti masalah secara singkat untuk memudahkan petugas (Max: 255 Karakter).</p>
                        </div>
                        ...
                        <div>
                            <label for="lampiran_screenshot" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lampiran Screenshot (Opsional namun sangat disarankan)</label>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Lampirkan tangkapan layar kejadian error. Format yang didukung: JPG, PNG, JPEG. Maksimal 2MB.</p>
                        </div>
    ...
    <div id="step-2" class="step-content hidden transition-opacity duration-300">
        <div class="text-center py-10 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto mt-8 shadow-sm">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-2">
                Terima kasih, laporan Anda telah masuk ke dalam antrean sistem untuk ditangani oleh tim teknis kami.
            </p>
            ...
            <div class="flex justify-center space-x-4">
                <a href="/tiket/riwayat" class="px-6 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
                    Cek Status Tiket
                </a>
