                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-xs font-bold text-gray-900 dark:text-white">Username</label>
                                ...
                                <div>
                                    <label class="block mb-2 text-xs font-bold text-gray-900 dark:text-white">Alamat
                                        Email</label>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div>
                                    <label class="block mb-2 text-xs font-bold text-gray-900 dark:text-white">Password
                                        Baru</label>
                                ...
                                <div>
                                    <label class="block mb-2 text-xs font-bold text-gray-900 dark:text-white">Konfirmasi
                                        Password Baru</label>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4">
                            ...
                            <button type="submit"
                                class="bg-blue-700 text-white px-12 py-3 rounded-xl font-bold hover:bg-blue-800 shadow-lg shadow-blue-500/30 transition-all transform active:scale-95 text-xs">Simpan
                                Perubahan</button>
                        </div>
                    </div>
