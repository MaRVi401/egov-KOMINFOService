    ...
    <section class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white uppercase tracking-widest text-left">
                        Pengaturan Profil</h2>
                    <p class="text-sm text-gray-500 mt-1 text-left">Kelola informasi pribadi dan keamanan akun Anda.</p>
                </div>
                <span
                    class="px-4 py-1.5 text-xs font-black text-blue-700 bg-blue-100 rounded-full uppercase tracking-wider dark:bg-blue-900/30 dark:text-blue-400">
            ...
            @if (session('success'))
                <div
                    class="p-4 mb-6 text-sm text-green-800 rounded-xl bg-green-50 border border-green-200 dark:bg-gray-800 dark:text-green-400 dark:border-green-900 shadow-sm flex items-center font-bold uppercase tracking-wide">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 text-gray-900">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <h3
                                class="text-lg font-bold mb-6 flex items-center dark:text-white uppercase tracking-wider text-left">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                ...
                                <div class="md:col-span-2">
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Nama
                                        Lengkap</label>
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">NIP
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Username</label>
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Alamat
                                        Email</label>
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Nomor
                                        WhatsApp</label>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="alamat" rows="3"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all">{{ old('alamat', $user->alamat) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                            <h3
                                class="text-lg font-bold mb-6 flex items-center dark:text-white uppercase tracking-wider text-left text-gray-900">
                                <svg class="w-5 h-5 me-2 text-blue-600" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Password
                                        Baru</label>
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">Konfirmasi
                                        Password Baru</label>
                                    <input type="password" name="password_confirmation" placeholder="••••••••"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all">
                                </div>
                            </div>
                            <p class="mt-4 text-[10px] text-gray-500 italic font-medium">*Kosongkan jika tidak ingin
                                mengubah password.</p>
                        </div>

                        <div class="flex items-center justify-end gap-4 pt-4">
                            <a href="{{ url()->previous() }}"
                                class="px-8 py-3 text-xs font-black text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors uppercase tracking-widest">Batal</a>
                            <button type="submit"
                                class="bg-blue-700 text-white px-12 py-3 rounded-xl font-black hover:bg-blue-800 shadow-lg shadow-blue-500/30 transition-all transform active:scale-95 uppercase tracking-widest text-xs">Simpan
                                Perubahan</button>
                        </div>
                    </div>
