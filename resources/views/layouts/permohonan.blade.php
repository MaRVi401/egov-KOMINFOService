    ...
    <div class="p-4 border-2 border-default border-dashed rounded-base dark:border-default-medium">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    {{-- Row 2 --}}
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">#REQ-2024-002</td>
                        <td class="px-6 py-4">Budi Santoso</td>
                        <td class="px-6 py-4">Perizinan UMKM</td>
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">#REQ-2024-003</td>
                        <td class="px-6 py-4">Siti Aminah</td>
                        <td class="px-6 py-4">Surat Pindah Domisili</td>
                        <td class="px-6 py-4">07 Feb 2026</td>
                        <td class="px-6 py-4">
        ...
        <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                Menampilkan <span class="font-semibold text-gray-900 dark:text-white">1-3</span> dari <span class="font-semibold text-gray-900 dark:text-white">100</span>
            </span>
