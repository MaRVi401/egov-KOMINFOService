    ...
    <section id="beranda" class="flex items-center justify-center py-20 lg:py-32 scroll-mt-20">
        <div class="grid max-w-7xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 items-center">
            <div class="mr-auto place-self-center lg:col-span-7 text-center lg:text-left">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl uppercase text-gray-900 dark:text-white">
    ...
    <section id="layanan" class="py-20 bg-gray-50 dark:bg-gray-800/50 scroll-mt-20">
        <div class="max-w-7xl px-4 mx-auto text-center">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="bg-white dark:bg-gray-900 flex flex-col border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm overflow-hidden transition-all hover:shadow-md">
                    <div class="p-6 bg-gray-50 dark:bg-gray-800/50 flex justify-center items-center aspect-square overflow-hidden">
    ...
    <section id="informasi" class="py-20 scroll-mt-20">
        <div class="max-w-7xl px-4 mx-auto">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">Dapatkan berita, artikel, dan pengumuman terbaru seputar transformasi digital di lingkungan pemerintah daerah.</p>
            </div>

            <div class="grid gap-8 lg:grid-cols-3">
                
                <article class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
                    <div class="relative">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-1.png" class="w-full h-52 object-cover" alt="Berita 1">
                        <span class="absolute top-4 left-4 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase">Berita</span>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center mb-3 text-sm text-gray-500 dark:text-gray-400">
                            <svg class="w-4 h-4 me-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        ...
                        <p class="mb-4 text-gray-500 dark:text-gray-400 line-clamp-2">Upaya percepatan digitalisasi birokrasi kini memasuki tahap integrasi sistem tanda tangan elektronik terpadu.</p>
                        <a href="#" class="inline-flex items-center font-medium text-blue-600 hover:underline">
                            Selengkapnya
                            <svg class="w-4 h-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
                    </div>
                </article>
                ...
                <article class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
                    <div class="relative">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png" class="w-full h-52 object-cover" alt="Berita 2">
                        <span class="absolute top-4 left-4 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase">Pengumuman</span>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center mb-3 text-sm text-gray-500 dark:text-gray-400">
                            <svg class="w-4 h-4 me-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        ...
                        <p class="mb-4 text-gray-500 dark:text-gray-400 line-clamp-2">Informasi mengenai jadwal maintenance server yang akan berdampak pada beberapa layanan publik digital sementara waktu.</p>
                        <a href="#" class="inline-flex items-center font-medium text-blue-600 hover:underline">
                            Selengkapnya
                            <svg class="w-4 h-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
                ...
                <article class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
                    <div class="relative">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-3.png" class="w-full h-52 object-cover" alt="Berita 3">
                        <span class="absolute top-4 left-4 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase">E-Gov</span>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center mb-3 text-sm text-gray-500 dark:text-gray-400">
                            <svg class="w-4 h-4 me-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        ...
                        <p class="mb-4 text-gray-500 dark:text-gray-400 line-clamp-2">Skor Indeks Sistem Pemerintahan Berbasis Elektronik (SPBE) mengalami kenaikan signifikan tahun ini.</p>
                        <a href="#" class="inline-flex items-center font-medium text-blue-600 hover:underline">
                            Selengkapnya
                            <svg class="w-4 h-4 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
            ...
            <div class="mt-12 text-center">
                <a href="#" class="inline-flex items-center px-6 py-3 text-base font-medium text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700">
                    Lihat Semua Berita
                </a>
            </div>
        </div>
