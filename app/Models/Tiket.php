...
class Tiket extends Model {
    ...
    public function petugas() { return $this->belongsTo(User::class, 'petugas_id', 'uuid'); }
    public function layanan() { return $this->belongsTo(Layanan::class, 'layanan_id', 'uuid'); }
    
    // Relasi ke detail (HasOne)
